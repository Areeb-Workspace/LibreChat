...
import { openrouterToolkit } from '~/tools/toolkits/openrouter';
...
export const toolDefinitions: Record<string, ToolRegistryDefinition> = {
  ...
  openrouter_image_gen: {
    name: openrouterToolkit.openrouter_image_gen.name,
    description: openrouterToolkit.openrouter_image_gen.description,
    schema: openrouterToolkit.openrouter_image_gen.schema,
    toolType: 'builtin',
    responseFormat: openrouterToolkit.openrouter_image_gen.responseFormat,
  },
  openrouter_image_fetch: {
    name: openrouterToolkit.openrouter_image_fetch.name,
    description: openrouterToolkit.openrouter_image_fetch.description,
    schema: openrouterToolkit.openrouter_image_fetch.schema,
    toolType: 'builtin',
    responseFormat: openrouterToolkit.openrouter_image_fetch.responseFormat,
  },
};
